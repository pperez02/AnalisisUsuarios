...
def borrar_pelicula(idPelicula: str, request: Request):
    ...
    return RedirectResponse(url=f"/administrador/peliculas/borrar?mensaje={mensaje}", status_code=303)              

@app.get("/administrador/series/borrar", response_class=HTMLResponse)
...
@app.post("/administrador/series/{idSerie}/borrar")
def borrar_serie(idSerie: str, request: Request):
    ...
    return RedirectResponse(url=f"/administrador/series/borrar?mensaje={mensaje}", status_code=303) 
